...
+55 31 992233966\\ % Your phone number
Born 10/22/1977 \\
\Sep % Some whitespace
\textbf{Address} \\
...
\aboutme{About Me}{Computer scientist of formation, I also had training on radiation protection and nuclear safety and security. I have experience in Linux
  ...
  engineers, being the only Computer Scientist. Most of the group activities are related to thermal-hydraulics and neutronics simulation of nuclear reactors. My current activities are related to software development aimed at multiphysics calculations and Linux systems administration. I am also the system administrator of a small HPC system of 9 nodes (180 processors).  Since 2025 accredited as faculty in a graduate programme in radiation, minerals, and materials science and technology and chair of the Internationalization Committee of CDTN's Graduate Program.}

%\textbf{(In sabbatical leave during 2020)}}
...
\CVItem{Oct 2021 - Oct 2023, \textit{Wissenschaftlicher Mitarbeiter (Research Fellow)  \textit{JSC}}, FZJ, [Jülich, GERMANY]}{
  Detailed achievements:
  \begin{itemize}
  \item Member of the support and development group for the JUWELS and JURECA supercomputers.
  \item Providing user support for the modeling, execution, and tuning of computational models..
  \item Developing the monitoring system.
  \item Participating in research projects.
  \item Main research project: CoEC — CFD analysis for combustion, focused on the optimization of I/O operations.
  \end{itemize}
}
...
\CVItem{German}{ \textit{Beginner. Limited understanding and speaking}.}\\
...
\CVItem{Professional}{Scientific computing and visulization, free software development, GPU programming, software parallelization techniques, HPC, Linux and heterogeneus computing and programming (SYCL), neutron imaging. Computer Science education and public outreach.}
