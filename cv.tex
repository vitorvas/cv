...
\CVItem{Professional}{Scientific computing and visulization, free software development, GPU programming, software parallelization techniques, HPC, Linux and heterogeneus computing and programming (SYCL).}
